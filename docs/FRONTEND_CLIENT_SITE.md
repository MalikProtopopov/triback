...
**Дата:** 2026-03-23 (обновлено — голосование: 403 при отсутствии подписки)  
...
**Кто может голосовать:** только активные члены ассоциации (врач со статусом ACTIVE и действующей подпиской). При отсутствии подписки или неодобренном статусе — **403 Forbidden**.

**Ошибки POST `/voting/{session_id}/vote`:**

| Код | Сообщение | Действие на фронте |
|-----|-----------|-------------------|
| 403 | «Голосовать могут только активные члены ассоциации» | Показать сообщение и ссылку на продление подписки (`/cabinet/subscription`) |
| 404 | Сессия или кандидат не найдены | «Голосование не найдено» |
| 409 | «You have already voted...» | Обновить UI на «уже проголосовал», убрать кнопку голосования |
